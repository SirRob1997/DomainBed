...
def _hparams(algorithm, dataset, random_seed):
    ...
    if algorithm in ['DANN', 'CDANN']:
        ...
        _hparam('drop_f', 0.5, lambda r: r.uniform(0.3,0.5))
        _hparam('ce_factor', 1, lambda r: 1)
        _hparam('cl_factor', 0.7, lambda r: r.uniform(0.7,0.8))
        _hparam('sep_factor', -0.08, lambda r: -0.08)
        #_hparam('l1_factor', 1e-4, lambda r: 1e-4)
        #_hparam('cpt_factor', 1e-4, lambda r: 1e-4)
        _hparam('intra_factor', 0.0, lambda r: 0.0)
