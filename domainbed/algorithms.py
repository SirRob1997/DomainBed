...
class ProDrop(ERM):
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        ...
        self.num_prototypes = hparams['num_prototypes'] # In ProtoPNet: 2000
        self.prototype_width = hparams['prototype_width'] # In ProtoPNet: 1
        self.prototype_height = hparams['prototype_height'] # In ProtoPNet: 1
